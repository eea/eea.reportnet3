...
/**
 * The Class ValidationRefusedEvent.
 */
@Component
public class ValidationFailedDatasetLockedForEditingExistsEvent implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.VALIDATION_FAILED_DATASET_LOCKED_FOR_EDITING_EXISTS_EVENT;
    }
