 ...
 */
@Component
public class ExecuteValidationCommandDL extends ExecuteValidationCommand {

  @Qualifier("dremioNonSqlRulesExecuteServiceImpl")
  @Autowired
  private DremioRulesExecuteService dremioRulesExecuteService;

  /** The Constant LOG. */
  private static final Logger LOG = LoggerFactory.getLogger(ExecuteValidationCommandDL.class);
  ...
  public EventType getEventType() {
    return EventType.COMMAND_VALIDATE_DL;
  }
  ...
  public EventType getNotificationEventType() {
    return EventType.COMMAND_VALIDATED_DL_COMPLETED;
  }
  ...
  public Validator getValidationAction() {
    try {
      ...
      LOG.error("Unexpected error! Error executing event COMMAND_VALIDATE_DL. Message: {}", e.getMessage());
      throw e;
    }
  }
}
