...
@Component
public class HighPriorityTaskKafkaReceiver extends KafkaReceiver {

    private static final Logger LOG = LoggerFactory.getLogger(HighPriorityTaskKafkaReceiver.class);

    @Override
    @KafkaListener(topics = "HIGH_PRIORITY_TASK_TOPIC")
