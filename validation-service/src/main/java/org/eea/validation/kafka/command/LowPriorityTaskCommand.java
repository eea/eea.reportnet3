...
@Component
public class LowPriorityTaskCommand extends AbstractEEAEventHandlerCommand {
    private static final Logger LOG = LoggerFactory.getLogger(LowPriorityTaskCommand.class);
    ...
    public EventType getEventType() {
        return EventType.LOW_PRIORITY_TASK_CREATED_EVENT;
    }

    @Override
    public void execute(EEAEventVO eeaEventVO) throws EEAException {

        final Long taskId = Long.valueOf((Integer) eeaEventVO.getData().get("taskId"));
