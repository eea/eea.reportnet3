    ...
    public void execute(Long dataflowId, Long datasetId, String datasetSchemaId, String tableName, String tableSchemaId, String ruleId, Long dataProviderId,
        ...
        try {
          ...
          switch (ruleMethodName) {
            ...
            query.append("select record_id,").append(fieldName != null ? dremioHelperService.addQuotesToFieldNames(fieldName) : "").append(" from ").append(s3Service.getTableAsFolderQueryPath(dataTableResolver, S3_TABLE_AS_FOLDER_QUERY_PATH));
