 ...
 */
public class DisabledQCRuleEventTest {

  /** The disabled QC rule event. */
  @InjectMocks
  private DisabledQCRuleEvent disabledQCRuleEvent;
  ...
  public void testGetEventType() {
    assertEquals(EventType.DISABLED_QC_RULE_EVENT, disabledQCRuleEvent.getEventType());
  }
