...
/**
 * The Class UpdateDocumentCompletedEvent.
 */
@Component
public class UpdateDocumentCompletedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.UPDATED_DOCUMENT_COMPLETED_EVENT;
  }
