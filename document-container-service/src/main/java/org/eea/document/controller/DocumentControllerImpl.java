...
public class DocumentControllerImpl implements DocumentController {
  ...
  public void uploadDocument(@RequestParam("file") final MultipartFile file,
  ...
  public ResponseEntity<Resource> getDocument(final String documentName, final Long dataFlowId) {
    try {
