...
/**
 * The Class ExternalImportReportingFailedEvent.
 */
@Component
public class ExternalImportReportingFailedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.EXTERNAL_IMPORT_REPORTING_FAILED_EVENT;
  }
