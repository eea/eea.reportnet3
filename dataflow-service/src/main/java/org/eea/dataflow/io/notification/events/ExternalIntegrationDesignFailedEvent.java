...
/**
 * The Class ExternalIntegrationDesignFailedEvent.
 */
@Component
public class ExternalIntegrationDesignFailedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.EXTERNAL_IMPORT_DESIGN_FROM_OTHER_SYSTEM_FAILED_EVENT;
  }
