...
public class ExternalImportDesignCompletedEventTest {

  @InjectMocks
  private ExternalImportDesignCompletedEvent externalImportDesignCompletedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_IMPORT_DESIGN_COMPLETED_EVENT,
        externalImportDesignCompletedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(6, externalImportDesignCompletedEvent.getMap(NotificationVO.builder()
