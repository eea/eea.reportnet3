...
public class ExternalImportDesignFailedEventTest {

  @InjectMocks
  private ExternalImportDesignFailedEvent externalImportDesignFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_IMPORT_DESIGN_FAILED_EVENT,
        externalImportDesignFailedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(6, externalImportDesignFailedEvent.getMap(NotificationVO.builder()
