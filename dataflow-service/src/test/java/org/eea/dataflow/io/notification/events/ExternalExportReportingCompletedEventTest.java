...
public class ExternalExportReportingCompletedEventTest {

  @InjectMocks
  private ExternalExportReportingCompletedEvent externalExportReportingCompletedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_EXPORT_REPORTING_COMPLETED_EVENT,
        externalExportReportingCompletedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(7, externalExportReportingCompletedEvent.getMap(NotificationVO.builder()
