...
public class ExternalIntegrationDesignFailedEventTest {

  @InjectMocks
  private ExternalIntegrationDesignFailedEvent externalIntegrationFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_IMPORT_DESIGN_FROM_OTHER_SYSTEM_FAILED_EVENT,
