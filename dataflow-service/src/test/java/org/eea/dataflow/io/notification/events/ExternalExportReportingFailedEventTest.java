...
public class ExternalExportReportingFailedEventTest {

  @InjectMocks
  private ExternalExportReportingFailedEvent externalExportReportingFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_EXPORT_REPORTING_FAILED_EVENT,
        externalExportReportingFailedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(7, externalExportReportingFailedEvent.getMap(NotificationVO.builder()
