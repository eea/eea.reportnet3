...
public class ExternalImportReportingFailedEventTest {

  @InjectMocks
  private ExternalImportReportingFailedEvent externalImportReportingFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_IMPORT_REPORTING_FAILED_EVENT,
        externalImportReportingFailedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(6, externalImportReportingFailedEvent.getMap(NotificationVO.builder()
