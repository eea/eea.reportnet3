...
public class ExternalExportEUDatasetFailedEventTest {

  @InjectMocks
  private ExternalExportEUDatasetFailedEvent externalExportEUDatasetFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_EXPORT_EUDATASET_FAILED_EVENT,
        externalExportEUDatasetFailedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(5, externalExportEUDatasetFailedEvent
