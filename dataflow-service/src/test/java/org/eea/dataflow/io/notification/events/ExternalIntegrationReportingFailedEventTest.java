...
public class ExternalIntegrationReportingFailedEventTest {

  @InjectMocks
  private ExternalIntegrationReportingFailedEvent externalIntegrationFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_IMPORT_REPORTING_FROM_OTHER_SYSTEM_FAILED_EVENT,
        externalIntegrationFailedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(5, externalIntegrationFailedEvent
