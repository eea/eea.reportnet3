...
public class ExternalExportDesignFailedEventTest {

  @InjectMocks
  private ExternalExportDesignFailedEvent externalExportDesignFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_EXPORT_DESIGN_FAILED_EVENT,
        externalExportDesignFailedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(6,
        externalExportDesignFailedEvent.getMap(NotificationVO.builder().user("user").datasetId(1L)
            .dataflowId(1L).fileName("fileName").providerId(1L).build()).size());
  }
}
