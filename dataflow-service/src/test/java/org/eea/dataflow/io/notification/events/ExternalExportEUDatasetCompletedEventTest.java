...
public class ExternalExportEUDatasetCompletedEventTest {

  @InjectMocks
  private ExternalExportEUDatasetCompletedEvent externalExportEUDatasetCompletedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.EXTERNAL_EXPORT_EUDATASET_COMPLETED_EVENT,
        externalExportEUDatasetCompletedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(6, externalExportEUDatasetCompletedEvent.getMap(NotificationVO.builder()
