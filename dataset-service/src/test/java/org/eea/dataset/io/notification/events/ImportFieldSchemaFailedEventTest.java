...
public class ImportFieldSchemaFailedEventTest {

  @InjectMocks
  private ImportFieldSchemaFailedEvent loadSchemaFailedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.IMPORT_FIELD_SCHEMA_FAILED_EVENT,
        loadSchemaFailedEvent.getEventType());
  }
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(7,
        loadSchemaFailedEvent.getMap(NotificationVO.builder().user("user").datasetId(1L)
            .dataflowId(1L).datasetName("datasetName").dataflowName("dataflowName")
            .tableSchemaId("tableSchemaId").tableSchemaName("tableSchemaName").error("error")
            .build()).size());
  }
  ...
  public void getMapFromMinimumDataTest() throws EEAException {
    ...
    Assert.assertEquals(7, loadSchemaFailedEvent.getMap(NotificationVO.builder().user("user")
