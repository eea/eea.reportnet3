...
public class CheckBlockersDataSnapshotCommandTest {
  ...
  public void testExecuteWithoutBlockers() throws EEAException {
    ...
    JobVO jobVO = new JobVO(Long.valueOf(1), JobTypeEnum.RELEASE, JobStatusEnum.QUEUED, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), null, "test", true, 1L, 1L, 1L, null, null, null);
