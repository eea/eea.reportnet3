...
public class DeleteTableCompletedEventTest {

  @InjectMocks
  private DeleteTableCompletedEvent deleteTableCompletedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.DELETE_TABLE_COMPLETED_EVENT,
  ...
  public void getMapFromMinimumDataTest() throws EEAException {
    ...
    Assert.assertEquals(7, deleteTableCompletedEvent
