...
public class ImportFieldSchemaCompletedEventTest {

  @InjectMocks
  private ImportFieldSchemaCompletedEvent loadSchemaCompletedEvent;
  ...
  public void getEventTypeTest() {
    Assert.assertEquals(EventType.IMPORT_FIELD_SCHEMA_COMPLETED_EVENT,
  ...
  public void getMapTest() throws EEAException {
    ...
    Assert.assertEquals(6,
        loadSchemaCompletedEvent.getMap(NotificationVO.builder().user("user").datasetId(1L)
            .dataflowId(1L).datasetName("datasetName").tableSchemaId("tableSchemaId")
            .tableSchemaName("tableSchemaName").build()).size());
  }
