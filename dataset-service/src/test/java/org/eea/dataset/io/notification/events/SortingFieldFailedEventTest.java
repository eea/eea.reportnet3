...
/**
 * The Class SortingFieldFailedEventTest.
 */
public class SortingFieldFailedEventTest {


  /** The sorting field failed event. */
  @InjectMocks
  private SortingFieldFailedEvent sortingFieldFailedEvent;
  ...
  public void testGetEventType() {
    Assert.assertEquals(EventType.SORT_FIELD_FAILED_EVENT, sortingFieldFailedEvent.getEventType());
  }
  ...
  public void testGetMap() throws EEAException {
    ...
    Assert.assertEquals("datasetName",
        sortingFieldFailedEvent.getMap(NotificationVO.builder().user("user").datasetId(1L)
