...
public class CopyDatasetSchemaNotElementsToCopyFailedEventTest {

  /** The copy dataset schema completed event. */
  @InjectMocks
  private CopyDatasetSchemaNotElementsToCopyFailedEvent copyDatasetSchemaNotElementsToCopyFailedEvent;
  ...
  public void testGetEventType() {
    Assert.assertEquals(EventType.COPY_DATASET_SCHEMA_NOT_FOUND_EVENT,
        copyDatasetSchemaNotElementsToCopyFailedEvent.getEventType());
  }
  ...
  public void testGetMap() throws EEAException {
    Assert.assertEquals("dataflowName",
        copyDatasetSchemaNotElementsToCopyFailedEvent
  ...
  public void testGetMapNulls() throws EEAException {
    ...
    Assert.assertNull(
        copyDatasetSchemaNotElementsToCopyFailedEvent.getMap(NotificationVO.builder().user("user")
