...
public interface TableValidationMapper extends IMapper<TableValidation, ValidationVO> {
  ...
  @Override
  TableValidation classToEntity(ValidationVO model);
  ...
  @Override
  ValidationVO entityToClass(TableValidation model);
