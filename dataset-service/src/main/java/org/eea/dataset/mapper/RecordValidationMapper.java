...
public interface RecordValidationMapper extends IMapper<RecordValidation, ValidationVO> {
  ...
  @Override
  RecordValidation classToEntity(ValidationVO model);
  ...
  @Override
  ValidationVO entityToClass(RecordValidation model);
