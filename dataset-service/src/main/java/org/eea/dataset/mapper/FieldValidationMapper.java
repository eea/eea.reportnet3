...
public interface FieldValidationMapper extends IMapper<FieldValidation, ValidationVO> {
  ...
  @Override
  FieldValidation classToEntity(ValidationVO model);
  ...
  @Override
  ValidationVO entityToClass(FieldValidation model);
