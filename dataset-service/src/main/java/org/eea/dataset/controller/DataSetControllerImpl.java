...
public class DataSetControllerImpl implements DatasetController {
  ...
  @PreAuthorize("secondLevelAuthorize(#datasetId,'DATASET_LEAD_REPORTER','DATACOLLECTION_CUSTODIAN') OR (hasRole('DATA_CUSTODIAN'))")
  ...
  @PreAuthorize("secondLevelAuthorize(#datasetId,'DATASET_LEAD_REPORTER','DATASCHEMA_CUSTODIAN')")
  ...
  @PreAuthorize("secondLevelAuthorize(#dataSetId,'DATASET_LEAD_REPORTER') AND checkPermission('Dataset','MANAGE_DATA')")
  ...
  @PreAuthorize("secondLevelAuthorize(#datasetId,'DATASET_LEAD_REPORTER','DATASET_REQUESTER','DATASCHEMA_CUSTODIAN','DATASET_CUSTODIAN')")
  ...
  @PreAuthorize("checkApiKey(#dataflowId,#providerId) AND secondLevelAuthorize(#datasetId,'DATASET_LEAD_REPORTER','DATASET_REQUESTER','DATASCHEMA_CUSTODIAN')")
