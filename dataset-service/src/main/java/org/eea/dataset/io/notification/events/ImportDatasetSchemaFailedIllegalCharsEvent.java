 ...
 */
@Component
public class ImportDatasetSchemaFailedIllegalCharsEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.IMPORT_DATASET_SCHEMA_FAILED_ILLEGAL_CHARS_EVENT;
  }
