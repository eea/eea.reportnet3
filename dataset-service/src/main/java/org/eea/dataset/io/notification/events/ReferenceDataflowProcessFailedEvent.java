...
/**
 * The Class ReferenceDataflowProcessFailedEvent.
 */
@Component
public class ReferenceDataflowProcessFailedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.REFERENCE_DATAFLOW_PROCESS_FAILED_EVENT;
  }
