...
/**
 * The Class DeleteDatasetSchemaCompletedEvent.
 */
@Component
public class DeleteDatasetSchemaCompletedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.DELETE_DATASET_SCHEMA_COMPLETED_EVENT;
  }
