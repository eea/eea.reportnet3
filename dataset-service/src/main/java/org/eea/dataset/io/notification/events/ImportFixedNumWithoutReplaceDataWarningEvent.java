...
public class ImportFixedNumWithoutReplaceDataWarningEvent implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.IMPORT_FIXED_NUM_WITHOUT_REPLACE_DATA_WARNING_EVENT;
    }
