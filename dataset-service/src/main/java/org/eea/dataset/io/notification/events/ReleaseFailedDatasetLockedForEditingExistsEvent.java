...
@Component
public class ReleaseFailedDatasetLockedForEditingExistsEvent implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.RELEASE_FAILED_DATASET_LOCKED_FOR_EDITING_EXISTS_EVENT;
    }
