 ...
 */
@Component
public class AddDataCollectionFailedEventDatasetLockedForEditingExists implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.ADD_DATACOLLECTION_FAILED_EVENT_DATASET_LOCKED_FOR_EDITING_EXISTS;
    }
