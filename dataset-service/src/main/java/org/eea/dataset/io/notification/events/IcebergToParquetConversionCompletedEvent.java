...
/**
 * The Class IcebergToParquetConversionCompletedEvent.
 */
@Component
public class IcebergToParquetConversionCompletedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.ICEBERG_TO_PARQUET_CONVERSION_COMPLETED_EVENT;
  }
