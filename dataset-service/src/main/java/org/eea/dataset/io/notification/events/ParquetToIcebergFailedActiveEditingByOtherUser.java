...
@Component
public class ParquetToIcebergFailedActiveEditingByOtherUser implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.PARQUET_TO_ICEBERG_FAILED_ACTIVE_EDITING_BY_OTHER_USER;
    }
