...
/**
 * The Class ParquetToIcebergConversionCompletedEvent.
 */
@Component
public class ParquetToIcebergConversionCompletedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.PARQUET_TO_ICEBERG_CONVERSION_COMPLETED_EVENT;
  }
  ...
  public Map<String, Object> getMap(NotificationVO notificationVO) throws EEAException {
    ...
    notification.put("message", "Parquet to Iceberg conversion completed successfully.");
    return notification;
  }
}
