 ...
 */
@Component
public class CopyDatasetSchemaFailedIllegalCharsEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.COPY_DATASET_SCHEMA_FAILED_ILLEGAL_CHARS_EVENT;
  }
