  ...
  public void execute(EEAEventVO eeaEventVO) throws EEAException {
    try {
      ...
      if (null != nextData) {
        ...
        LOG.info("Created release process for RELEASE_ONEBYONE_COMPLETED_EVENT on ReleaseDataSnapshotsCommand.execute for datasetId {}, dataflowId {} ", datasetId, dataset.getDataflowId());
