...
/**
 * The Class CopyDatasetSchemaCompletedEvent.
 */
@Component
public class CopyDatasetSchemaCompletedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.COPY_DATASET_SCHEMA_COMPLETED_EVENT;
  }
