...
@Component
public class DatasetDisableEditingFailedActiveEditingByOtherUserEvent implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.DATASET_DISABLE_EDITING_FAILED_ACTIVE_EDITING_BY_OTHER_USER_EVENT;
    }
