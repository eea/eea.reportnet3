...
@Component
public class PreparationDatasetCreationHasEmptyQueueEvent implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.PREPARATION_DATASET_CREATION_HAS_EMPTY_QUEUE_EVENT;
    }
