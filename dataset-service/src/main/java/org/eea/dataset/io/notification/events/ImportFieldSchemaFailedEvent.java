...
/**
 * The Class ImportFieldSchemaFailedEvent.
 */
@Component
public class ImportFieldSchemaFailedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.IMPORT_FIELD_SCHEMA_FAILED_EVENT;
  }
