...
/**
 * The Class CopyDatasetSchemaNotElementsToCopyFailedEvent.
 */
@Component
public class CopyDatasetSchemaNotElementsToCopyFailedEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.COPY_DATASET_SCHEMA_NOT_FOUND_EVENT;
  }
