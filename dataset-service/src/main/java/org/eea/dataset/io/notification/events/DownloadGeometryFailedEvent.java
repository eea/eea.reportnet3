...
@Component
public class DownloadGeometryFailedEvent implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.DOWNLOAD_GEOMETRY_FAILED_EVENT;
    }
    ...
    public Map<String, Object> getMap(NotificationVO vo) throws EEAException {
        ...
        map.put("message", "Geometry download has failed");
