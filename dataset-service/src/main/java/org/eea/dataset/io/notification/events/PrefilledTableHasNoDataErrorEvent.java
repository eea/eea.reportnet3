...
/**
 * The Class PrefilledTableHasNoDataErrorEvent.
 */
@Component
public class PrefilledTableHasNoDataErrorEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.PREFILLED_TABLE_HAS_NO_DATA_ERROR;
  }
