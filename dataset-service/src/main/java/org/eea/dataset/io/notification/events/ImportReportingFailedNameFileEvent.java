...
/**
 * The Class ImportReportingFailedNameFileEvent.
 */
@Component
public class ImportReportingFailedNameFileEvent implements NotificableEventHandler {
  ...
  public EventType getEventType() {
    return EventType.IMPORT_REPORTING_FAILED_NAMEFILE_EVENT;
  }
