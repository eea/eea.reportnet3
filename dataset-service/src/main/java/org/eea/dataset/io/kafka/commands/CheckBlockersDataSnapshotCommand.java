...
public class CheckBlockersDataSnapshotCommand extends AbstractEEAEventHandlerCommand {
  ...
  public void execute(EEAEventVO eeaEventVO) throws EEAException {
    ...
    try {
      ...
      JobVO releaseJob = new JobVO(null, JobTypeEnum.RELEASE, JobStatusEnum.IN_PROGRESS, ts, ts, parameters, user,true, dataset.getDataflowId(), dataset.getDataProviderId(), null, null,null, dataflowName,null, null, null, null);
