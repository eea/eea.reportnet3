...
@Component
public class AnotherPreparationDatasetCreationIsRunningFailedEvent implements NotificableEventHandler {
    ...
    public EventType getEventType() {
        return EventType.ANOTHER_PREPARATION_DATASET_CREATION_IS_RUNNING_FAILED_EVENT;
    }
