...
public final class LiteralConstants {
  ...
  public static final String S3_SNAPSHOT_TABLE_NAME_SNAPSHOT_PATH = "%s/%s/%s/snapshots/%s";
  ...
  public static final String S3_PREPARATION_ATTACHMENTS_PATH = "%s/%s/%s/preparation/%s/attachments/%s/%s";
