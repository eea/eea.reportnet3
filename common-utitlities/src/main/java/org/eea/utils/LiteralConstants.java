...
public final class LiteralConstants {
  ...
  public static final String S3_ATTACHMENTS_DC_FOLDER_PATH = "%s/collections/%s/current/attachments/%s/%s";
  ...
  /** The Constant S3_ATTACHMENTS_EU_FOLDER_PATH: {@value}. */
  public static final String S3_ATTACHMENTS_EU_FOLDER_PATH = "%s/collections/%s/attachments/%s/%s";
  ...
  /** The Constant S3_TECHNICAL_ACCEPTANCE_FILE_PATH: {@value}. */
  public static final String S3_TECHNICAL_ACCEPTANCE_FILE_PATH= "%s/%s/technicalAcceptance/%s";
  ...
  /** The Constant GKPG_TYPE: {@value}. */
  public static final String GKPG_TYPE = ".gpkg";
