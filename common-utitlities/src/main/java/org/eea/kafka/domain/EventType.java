...
public enum EventType {
  ...
  /** The import namefile warning event. */
  ...
  /** The import with read only tables error event. */
  IMPORT_READ_ONLY_TABLES_ERROR_EVENT(LiteralConstants.DATA_REPORTING_TOPIC,
          "import_readOnlyTables_error_event", true),
