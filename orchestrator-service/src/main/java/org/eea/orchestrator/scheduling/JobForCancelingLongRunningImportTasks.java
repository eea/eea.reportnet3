                ...
                for (JobVO job: longRunningJobs){
                    ...
                    for(String processId: processIds){
                        ...
                        if(longRunningTasksExist) {
                            //update tasks status
                            validationControllerZuul.updateTaskStatusByProcessIdAndCurrentStatus(processId, ProcessStatusEnum.CANCELED, new HashSet<>(Arrays.asList(ProcessStatusEnum.IN_QUEUE.toString(), ProcessStatusEnum.IN_PROGRESS.toString())));
