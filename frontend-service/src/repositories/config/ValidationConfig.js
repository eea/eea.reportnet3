export const ValidationConfig = {
  ...
  downloadShowValidationsFile: '/validation/downloadFile/{:datasetId}?fileName={:fileName}&code={:code}',
  ...
  generateShowValidationsFile: '/validation/export/{:datasetId}?code={:code}',
