export const DataflowConfig = {
  ...
  getIcebergTables: '/dataset/getIcebergTables?dataflowId={:dataflowId}',
  getIcebergTablesWithProviderId: '/dataset/getIcebergTables?dataflowId={:dataflowId}&providerId={:providerId}',
  getPublicData:
