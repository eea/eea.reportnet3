...
import { BusinessDataflowService } from 'core/services/Dataflow';
...
const ManageBusinessDataflow = forwardRef(
      ...
      if (!errors.obligation.hasErrors && !errors.name.hasErrors && !errors.description.hasErrors) {
        ...
        try {
          if (isEditForm) {
            ...
            const creationResponse = await BusinessDataflowService.create(name, description, data.obligation.id);
            if (pinned) {
