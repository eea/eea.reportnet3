...
export const ReferenceDataflowService = {
  ...
  create: async (name, description, type, bigData, sncData, officialReporting, useViews) =>
    ReferenceDataflowRepository.create(name, description, type, bigData, sncData, officialReporting, useViews),

  update: async (dataflowId, description, name, type, bigData, officialReporting,useViews) =>
    ReferenceDataflowRepository.update(dataflowId, description, name, type, bigData, officialReporting,useViews),
