...
export const Organization = ({
  ...
  isAdmin = false,
  isOrganizationDialogVisible,
  placeholder,
  representativeId,
  roleOptions,
  saveErrorNotificationKey,
  setHasReporters = () => {},
  setIsOrganizationDialogVisible,
  ...
  useEffect(() => {
    if (!userRight.isNew && dropdownRef.current && isOrganizationDialogVisible) {
      dropdownRef.current.focusInput.focus();
    }
  }, [dropdownRef.current, isOrganizationDialogVisible]);

  useInputTextFocus(isOrganizationDialogVisible, inputRef);
  ...
  const onCloseManagementDialog = () => {
    setIsOrganizationDialogVisible(false);
  ...
  const onEditUserRight = userRight => {
    ...
    setIsOrganizationDialogVisible(true);
  };
    ...
    return (
      <div className={styles.table}>
        <DataTable
          ...
          totalRecords={shareRightsState.userRightList.length}
          value={shareRightsState.userRightList}>
  ...
  const getShareRightsColumns = () => {
    const columns = [
      ...
      {
        key: 'role',
        header: resourcesContext.messages['providerCode'],
        template: renderRoleColumnTemplate
      },
      {
        key: 'actions',
        header: resourcesContext.messages['providerGroup'],
    ...
    <Fragment>
      ...
      {isOrganizationDialogVisible && (
        <ConfirmDialog
          ...
          visible={isOrganizationDialogVisible}>
