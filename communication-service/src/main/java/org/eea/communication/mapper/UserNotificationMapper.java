...
public interface UserNotificationMapper extends IMapper<UserNotification, UserNotificationVO> {
  ...
  @Mapping(source = "nonLatinCharacters", target = "content.nonLatinCharacters")
  @Mapping(source = "preparationCode", target = "content.preparationCode")
  @Mapping(source = "preparationDatasetMessagePart", target = "content.preparationDatasetMessagePart")
  ...
  @Mapping(source = "content.nonLatinCharacters", target = "nonLatinCharacters")
  @Mapping(source = "content.preparationCode", target = "preparationCode")
  @Mapping(source = "content.preparationDatasetMessagePart", target = "preparationDatasetMessagePart")
