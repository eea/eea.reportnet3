...
declarar variables de entorno.
  ...
  https://rn3api.eionet.europa.eu/
  	...
  	TESTS:
		...
		Cloning schema
			/dataschema/copy?sourceDataflow=11&targetDataflow=12
		...
		Create snapshot	
			/snapshot/dataschema/607e8b5d1e32710001628460/dataset/5/create?description=ds1
		Restore snapshot
