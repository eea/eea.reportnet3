...
GRANT ALL ON TABLE public.jobs TO testuser,dataflow,dataset,validation,recordstore;
GRANT ALL ON SEQUENCE public.jobs_id_seq TO testuser,dataflow,dataset,validation,recordstore;
...
GRANT ALL ON TABLE public.job_history TO testuser,dataflow,dataset,validation,recordstore;
GRANT ALL ON SEQUENCE public.job_history_id_seq TO testuser,dataflow,dataset,validation,recordstore;